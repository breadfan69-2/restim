...
from device.focstim.notifications_pb2 import (NotificationBoot, NotificationDeviceVolume, NotificationCurrents, \
    ...
    NotificationBattery, NotificationLSM6DSOX, NotificationPressure, NotificationButtonPress, \
    NotificationDebugString, NotificationDebugAS5311, NotificationDebugTeleplot)
